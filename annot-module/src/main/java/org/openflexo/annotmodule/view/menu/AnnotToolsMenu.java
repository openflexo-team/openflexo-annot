...
public class AnnotToolsMenu extends ToolsMenu {

	@SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger(AnnotToolsMenu.class.getPackage().getName());
	...
	public AnnotToolsMenu(AnnotController controller) {
		super(controller);
