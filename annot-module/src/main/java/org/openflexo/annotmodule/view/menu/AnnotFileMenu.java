...
public class AnnotFileMenu extends FileMenu {

	@SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger(AnnotFileMenu.class.getPackage().getName());
	...
	public AnnotFileMenu(AnnotController controller) {
		super(controller);
