...
public class AnnotWindowMenu extends WindowMenu {
	...
	private static final Logger logger = Logger.getLogger(AnnotWindowMenu.class.getPackage().getName());
	...
	protected AnnotController annotController;
