...
public class AnnotProjectBrowser extends AbstractAnnotProjectBrowser {
	...
	private static final Resource BROWSER_FIB = ResourceLocator.locateResource("Fib/AnnotProjectBrowser.fib");

	public AnnotProjectBrowser(final FlexoController controller) {
