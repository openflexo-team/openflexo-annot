...
@ModelEntity
@XMLElement
@ImplementationClass(AnnotInstance.AnnotInstanceImpl.class)
public interface AnnotInstance extends VirtualModelInstanceBasedNatureObject<AnnotProjectNature> {

	public abstract class AnnotInstanceImpl extends VirtualModelInstanceBasedNatureObjectImpl<AnnotProjectNature> implements AnnotInstance {

		@SuppressWarnings("unused")
		private static final Logger logger = FlexoLogger.getLogger(AnnotInstance.class.getPackage().getName());
